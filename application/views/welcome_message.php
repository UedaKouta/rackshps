...
<link rel="stylesheet" href="css/slide.css">
 -->
<link href="<?php echo base_url(); ?>rackshp/css/style.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url(); ?>rackshp/css/slide.css" rel="stylesheet" type="text/css" />
<!--[if lt IE 9]>
...
<img src="<?php echo base_url(); ?>rackshp/images/top2.jpg" alt="" id="slide2">
<img src="<?php echo base_url(); ?>rackshp/images/top3.jpg" alt="" id="slide3">
</aside>
...
<h3>利用規約のご案内</h3>
<p>このテンプレートは、<a href="http://template-party.com/">Template Party</a>にて無料配布している『ビジネス・企業向け無料ホームページテンプレート tp_biz35』です。必ずダウンロード先のサイトの<a href="http://template-party.com/read.html">利用規約</a>をご一読の上でご利用下さい。</p>
...
<dl id="newinfo">
<dt>2017/02/27</dt>
<dd>html,cssを中心に更新。旧ファイルが必要な場合はお問い合わせ下さい。<span class="newicon">NEW</span></dd>
<dt>2016/02/19</dt>
<dd>biz35公開。</dd>
<dt>20XX/00/00</dt>
<dd>ホームページリニューアル</dd>
